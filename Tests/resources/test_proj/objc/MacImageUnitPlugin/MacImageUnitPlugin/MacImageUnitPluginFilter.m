...
#import "MacImageUnitPluginFilter.h"
#import <Foundation/Foundation.h>
#import <ApplicationServices/ApplicationServices.h>

@implementation MacImageUnitPluginFilter
...
- (instancetype)init
{
    if(!____PACKAGENAMEASIDENTIFIER___FilterKernel) {
        NSBundle    *bundle = [NSBundle bundleForClass:NSClassFromString(@"MacImageUnitPluginFilter")];
        NSStringEncoding encoding = NSUTF8StringEncoding;
        NSError     *error = nil;
        NSString    *code = [NSString stringWithContentsOfFile:[bundle pathForResource:@"MacImageUnitPluginFilterKernel" ofType:@"cikernel"] encoding:encoding error:&error];
