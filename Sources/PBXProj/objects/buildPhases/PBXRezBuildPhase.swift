...
public final class PBXRezBuildPhase: PBXBuildPhase {
    ...
    /// Create a new insatnce of Res Build Phase
    ///
    /// - Parameters:
    ...
    internal init(id: PBXReference,
                buildActionMask: UInt = PBXRezBuildPhase.DEFAULT_BUILD_ACTION_MAKS,
                files: [PBXReference] = [],
                runOnlyForDeploymentPostprocessing: UInt = 0) {
        
        super.init(id: id,
                   buildPhaseType: .carbonResourceBuildPhase,
    ...
    internal override class func getPBXEncodingComments(forValue value: String,
        ...
        if path.count == 2  { return PBXBuildPhase.PBXBuildPhaseType.carbonResourceBuildPhase.rawValue }
