...
public class PBXAppleScriptBuildPhase: PBXBuildPhase {
    ...
    /// Create a new insatnce of Apple Script Build Phase
    ///
    /// - Parameters:
    ...
    internal init(id: PBXReference,
                  buildActionMask: UInt = PBXAppleScriptBuildPhase.DEFAULT_BUILD_ACTION_MAKS,
                  files: [PBXReference] = [],
                  runOnlyForDeploymentPostprocessing: UInt = 0) {
        
        super.init(id: id,
                   buildPhaseType: .appleScriptBuildPhase,
