...
public final class PBXHeadersBuildPhase: PBXBuildPhase {
    ...
    /// Create a new insatnce of Headers Build Phase
    ///
    /// - Parameters:
    ...
    internal init(id: PBXReference,
                buildActionMask: UInt = PBXHeadersBuildPhase.DEFAULT_BUILD_ACTION_MAKS,
                files: [PBXReference] = [],
                runOnlyForDeploymentPostprocessing: UInt = 0) {
        
        super.init(id: id,
                   buildPhaseType: .headersBuildPhase,
    ...
    internal override class func getPBXEncodingComments(forValue value: String,
        ...
        if path.count == 2  { return PBXBuildPhase.PBXBuildPhaseType.headersBuildPhase.rawValue }
