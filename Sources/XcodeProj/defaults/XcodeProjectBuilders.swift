...
public struct XcodeProjectBuilders {
    ...
    private static let INTERNAL_OBJECT_VERSION_DEFAULT_DETAILS: [DefaultDetails] = [
        ...
        DefaultDetails(objectVersion: 46,
         ...
         DefaultDetails(objectVersion: 50,
                        compatibleXcode: "Xcode 11.1",
                         swiftVersion: "Swift 5.1.1",
                         macDeploymentTarget: "macOS 10.15",
                         iOSDeploymentTarget: "iOS 13.1",
                         tvOSDeploymentTarget: "tvOS 13",
                         watchOSDeploymentTarget: "watchOS 6"),
        DefaultDetails(objectVersion: 50,
                       compatibleXcode: "Xcode 11.2",
                        swiftVersion: "Swift 5.1.2",
                        macDeploymentTarget: "macOS 10.15.1",
                        iOSDeploymentTarget: "iOS 13.2",
                        tvOSDeploymentTarget: "tvOS 13.2",
                        watchOSDeploymentTarget: "watchOS 6.1"),
        DefaultDetails(objectVersion: 50,
                       compatibleXcode: "Xcode 11.3",
                        swiftVersion: "Swift 5.1.3",
                        macDeploymentTarget: "macOS 10.15",
                        iOSDeploymentTarget: "iOS 13.1",
                        tvOSDeploymentTarget: "tvOS 13",
                        watchOSDeploymentTarget: "watchOS 6"),
        DefaultDetails(objectVersion: 50,
                       compatibleXcode: "Xcode 11.3",
                        swiftVersion: "Swift 5.1.4",
                        macDeploymentTarget: "macOS 10.15.2",
                        iOSDeploymentTarget: "iOS 13.3",
                        tvOSDeploymentTarget: "tvOS 13.3",
                        watchOSDeploymentTarget: "watchOS 6.1.1"),
        DefaultDetails(objectVersion: 50,
                       compatibleXcode: "Xcode 11.3",
                       swiftVersion: "Swift 5.1.5",
                       macDeploymentTarget: "macOS 10.15.2",
                       iOSDeploymentTarget: "iOS 13.3",
                       tvOSDeploymentTarget: "tvOS 13.3",
                       watchOSDeploymentTarget: "watchOS 6.1.1"),
        DefaultDetails(objectVersion: 50,
                       compatibleXcode: "Xcode 11.4",
                        swiftVersion: "Swift 5.2",
                        macDeploymentTarget: "macOS 10.15.4",
                        iOSDeploymentTarget: "iOS 13.4",
                        tvOSDeploymentTarget: "tvOS 13.4",
                        watchOSDeploymentTarget: "watchOS 6.2"),
        DefaultDetails(objectVersion: 50,
                       compatibleXcode: "Xcode 11.4",
                        swiftVersion: "Swift 5.2.1",
                       macDeploymentTarget: "macOS 10.15.4",
                       iOSDeploymentTarget: "iOS 13.4",
                       tvOSDeploymentTarget: "tvOS 13.4",
                       watchOSDeploymentTarget: "watchOS 6.2"),
        DefaultDetails(objectVersion: 50,
                       compatibleXcode: "Xcode 11.4.1",
                        swiftVersion: "Swift 5.2.2",
                       macDeploymentTarget: "macOS 10.15.4",
                       iOSDeploymentTarget: "iOS 13.4",
                       tvOSDeploymentTarget: "tvOS 13.4",
                       watchOSDeploymentTarget: "watchOS 6.2"),
        DefaultDetails(objectVersion: 50,
                       compatibleXcode: "Xcode 11.4.1",
                        swiftVersion: "Swift 5.3.3",
                       macDeploymentTarget: "macOS 10.15.4",
                       iOSDeploymentTarget: "iOS 13.4",
                       tvOSDeploymentTarget: "tvOS 13.4",
                       watchOSDeploymentTarget: "watchOS 6.2"),
        DefaultDetails(objectVersion: 50,
                       compatibleXcode: "Xcode 11.5",
                        swiftVersion: "Swift 5.2.4",
                        macDeploymentTarget: "macOS 10.15.4",
                        iOSDeploymentTarget: "iOS 13.5",
                        tvOSDeploymentTarget: "tvOS 13.4",
                        watchOSDeploymentTarget: "watchOS 6.2"),
        DefaultDetails(objectVersion: 50,
                       compatibleXcode: "Xcode 11.5",
                        swiftVersion: "Swift 5.2.5",
                       macDeploymentTarget: "macOS 10.15.4",
                       iOSDeploymentTarget: "iOS 13.5",
                       tvOSDeploymentTarget: "tvOS 13.4",
                       watchOSDeploymentTarget: "watchOS 6.2"),
        DefaultDetails(objectVersion: 50,
                       compatibleXcode: "Xcode 12",
                        swiftVersion: "Swift 5.3",
                        macDeploymentTarget: "macOS 10.15.6",
                        iOSDeploymentTarget: "iOS 14",
                        tvOSDeploymentTarget: "tvOS 14",
                        watchOSDeploymentTarget: "watchOS 7"),
        DefaultDetails(objectVersion: 50,
                       compatibleXcode: "Xcode 12.2",
                       swiftVersion: "Swift 5.3.1",
                       macDeploymentTarget: "macOS 11",
                       iOSDeploymentTarget: "iOS 14.1",
                       tvOSDeploymentTarget: "tvOS 14",
                       watchOSDeploymentTarget: "watchOS 7"),
        DefaultDetails(objectVersion: 50,
                       compatibleXcode: "Xcode 12.3",
                        swiftVersion: "Swift 5.3.2",
                       macDeploymentTarget: "macOS 11.1",
                       iOSDeploymentTarget: "iOS 14.3",
                       tvOSDeploymentTarget: "tvOS 14.3",
                       watchOSDeploymentTarget: "watchOS 7.2"),
        DefaultDetails(objectVersion: 50,
                       compatibleXcode: "Xcode 12.3",
                        swiftVersion: "Swift 5.3.3",
                       macDeploymentTarget: "macOS 11.1",
                       ...
                       watchOSDeploymentTarget: "watchOS 7.2"),
        DefaultDetails(objectVersion: 50,
                       compatibleXcode: "Xcode 12.5",
                        swiftVersion: "Swift 5.4",
                       macDeploymentTarget: "macOS 11.3",
                       iOSDeploymentTarget: "iOS 14.5",
                       tvOSDeploymentTarget: "tvOS 14.5",
                       watchOSDeploymentTarget: "watchOS 7.4"),
        DefaultDetails(objectVersion: 50,
                       compatibleXcode: "Xcode 12.5",
                        swiftVersion: "Swift 5.4.1",
                       macDeploymentTarget: "macOS 11.3",
                       iOSDeploymentTarget: "iOS 14.5",
                       tvOSDeploymentTarget: "tvOS 14.5",
                       watchOSDeploymentTarget: "watchOS 7.4"),
        DefaultDetails(objectVersion: 50,
                       compatibleXcode: "Xcode 12.5.1",
                        swiftVersion: "Swift 5.4.2",
                       macDeploymentTarget: "macOS 11.3",
                       iOSDeploymentTarget: "iOS 14.5",
                       tvOSDeploymentTarget: "tvOS 14.5",
                       watchOSDeploymentTarget: "watchOS 7.4"),
        DefaultDetails(objectVersion: 50,
                       compatibleXcode: "Xcode 12.5.1",
                        swiftVersion: "Swift 5.4.3",
                       macDeploymentTarget: "macOS 11.3",
                       iOSDeploymentTarget: "iOS 14.5",
                       tvOSDeploymentTarget: "tvOS 14.5",
                       watchOSDeploymentTarget: "watchOS 7.4"),
        DefaultDetails(objectVersion: 50,
                       compatibleXcode: "Xcode 13",
                        swiftVersion: "Swift 5.5",
                        macDeploymentTarget: "macOS 11.3",
                        iOSDeploymentTarget: "iOS 14.5",
                        tvOSDeploymentTarget: "tvOS 14.5",
                        watchOSDeploymentTarget: "watchOS 7.4"),
        DefaultDetails(objectVersion: 50,
                       compatibleXcode: "Xcode 13.1",
                        swiftVersion: "Swift 5.5.1",
                       macDeploymentTarget: "macOS 12",
                       iOSDeploymentTarget: "iOS 15",
                       tvOSDeploymentTarget: "tvOS 15",
                       watchOSDeploymentTarget: "watchOS 8"),
        DefaultDetails(objectVersion: 50,
                       compatibleXcode: "Xcode 13.12",
                        swiftVersion: "Swift 5.5.2",
                       macDeploymentTarget: "macOS 12.1",
                       iOSDeploymentTarget: "iOS 15.2",
                       tvOSDeploymentTarget: "tvOS 15.2",
                       watchOSDeploymentTarget: "watchOS 8.3")
    ]
